...
class App:
    ...
    def set_theme(self, file_name: str) -> None:
        display_util.theme = file_name[file_name.index(self.WORD_THEME_) + len(self.WORD_THEME_): file_name.index('.json')]
